...
local mappings = {
	...
	a = {
		name = "Harpoon",
		a = { "<cmd>lua require('harppon.mark').add_file()<CR>" },
		r = { "<cmd>lua require('harppon.mark').remove_file()<CR>" },
		t = { "<cmd>lua require('harppon.mark').toggle_file()<CR>" },
		...
		["5"] = { "<cmd>lua require('harpoon.ui').nav_file(5)<CR>", "Harpoon 4" },
		["6"] = { "<cmd>lua require('harpoon.ui').nav_file(6)<CR>", "Harpoon 4" },
	},
	f = {
		name = "Files",
